...
const LandingPage = () => {
    ...
    return (
     <div className="flex flex-col items-center">
        ...
        <Input type="url" paceholder="Enter your loong URL" value={longURL}
        onChange={(e)=>setLongURL(e.target.value)} className="h-full flex-1 py-4 px-4"/>
        <Button className="h-full" type="submit" variant="destructive">Shorten!</Button>
        </form>
        <div>
            <img src="./banner1.jpg" className="w-full my-11 md:px-11" alt="banner" />
            ...
            <AccordionItem value="item-3">
                ...
                <AccordionContent>
                YYou can view the number of clicks, geolocation data of the clicks
